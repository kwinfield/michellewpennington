...
@section('title', "Michelle W. Pennington")
    ...
    <div class="row justify-content-center">
        @foreach ($books as $book)
            <div class="col-8 text-center">
                <img src="{{ $book->image }}" alt="Book Photo" class="img-fluid">
            </div>
        @endforeach
        ...
        <div class="p-5 lg-p-5 mt-3 text-center">
            ...
            <a href="book/{{ $book->id }}"><button class="btn btn-success mb-3">Buy Now</button></a>
            <hr>
        </div>
